                        ...
                        <div className="flex flex-col justify-between max-w-xs">
                            ...
                            <div className="relative bg-gray-dark space-y-4 px-5 py-6 rounded-md overflow-hidden">
                                ...
                                <div className="flex space-x-5">
                                    <div className="w-10 h-10 rounded-full bg-light" style={{ backgroundImage:'url(https://www.svgrepo.com/show/446529/avatar.svg)', backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
