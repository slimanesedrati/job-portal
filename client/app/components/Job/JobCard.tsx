...
const JobCard: React.FC<JobCardParams> = ({  }) => {
    return (
        <div className="relative border border-gray-300 flex flex-col max-w-xs space-y-3 p-5 duration-200 hover:border-blue rounded-xl hover:shadow-md bg-white">
            {/* Card Header */}
            <span className="absolute text-gray-med right-5 top-5 text-xs"> 5 juily </span>
            ...
            {/* Card Content */}
            <h3 className="capitalize font-bold text-md mb-4"> Marketing Coordinator </h3>
            <div className="tags">
                <span className="bg-sky-100 px-3 py-1 text-xs  text-blue rounded-xl">Full-time</span>
            ...
            <div className="flex items-center space-x-2 text-gray-500">
                ...
                <span className="text-sm font-bold">$80k - $150K</span>
            </div>
            <div>
                ...
                <p className="text-xs text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem in.</p>
            </div>
            {/* Card Footer */}
            <div className="flex gap-x-3 py-4">
                <Button className="bg-white border-2 border-primary text-primary rounded-lg hover:bg-primary hover:bg-opacity-10  w-1/2 hover:border-4 capitalize duration-150">
                    Contact
                </Button>
                <Button  className="text-white rounded-lg border-2 border-primary duration-150 hover:bg-opacity-75  capitalize w-1/2">
                    Apply
                </Button>
            </div>
